package id.havanah.app.dietonline.lib;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, (int) Utils.convertDpToPixels(getContext(), 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = (int) Utils.convertDpToPixels(getContext(), DEF_DRAW_SIZE);
